...
(function () {
  ...
  const BUILD_CATALOG = [
    ...
    // --- prefab whole structures ---
    { key: "house",      name: "House",      price: 3000, color: "#d9a066", cat: "Prefab" },
    { key: "mansion",    name: "Mansion",    price: 12000,color: "#c9b59a", cat: "Prefab" },
    { key: "shop",       name: "Shop",       price: 6000, color: "#e0c27a", cat: "Prefab" },
    { key: "pool",       name: "Pool",       price: 4000, color: "#39b6e0", cat: "Prefab" },
    // --- vehicles ---
  ...
  function buildBuilderDOM() {
    ...
    div.innerHTML = `
      ...
      <div id="bld-hint">WASD move · BUILD to place parts · R rotate · X remove · E ride · build walls/floors/roofs ARK-style</div>
